...
import com.example.android_client.bean.Step;
...
public class testActivity_1 extends AppCompatActivity{
    ...
    private int myColor;private  String name;
        ...
        public void init(Canvas canvas) {
            ...
            if (judge.judgesf()!=0){
                ...
                if (gameId==-1) canvas.drawText("游戏未开始", arm*32,arm*12, mPaint);
                    ...
                    else  canvas.drawText("对方落子", arm * 32, arm * 12, mPaint);
                }
            }
                                ...
                                if (gameId==-1) {
                                    ...
                                    if (judge.stepTurn == myColor) {
                                     //  judge.st[++judge.tot] = now;  //悔棋。。。
                                        ...
                                        Toast.makeText(getApplicationContext(), "落子成功", Toast.LENGTH_SHORT).show();
                                        luozi(i * 11 + j);
                                        invalidate();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(new testActivity_1.Panel(getApplicationContext()));
            ...
            while (!stopFlag){
                ...
                MainActivity.okHttpClient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onResponse(@NotNull Call call, @NotNull Response response) throws IOException {
                        ...
                        if (data!=null) {
                            double gameId_ = (double) data.get("gameId");
                            gameId = new Double(gameId_).intValue();
                            double userBlack_ = (double) data.get("userBlack");int userBlack = new Double(userBlack_).intValue();
                            double userWhite_ = (double) data.get("userWhite");int userWhite = new Double(userWhite_).intValue();
    ...
    public void leaveTable( ){
        String url= "http://10.163.138.25:8080/chessTable/leaveTable?tableId="+tableId+"&userId="+userId;
